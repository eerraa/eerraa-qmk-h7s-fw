...
// 보드/USB 식별
// ---------------------------------------------------------------------------
#define KBD_NAME                    "MAY65S"  // V260428R1: MAY65S 보드명으로 변경
#define USB_VID                     0x4552
#define USB_PID                     0x0030   // V260428R1: MAY65S VIA JSON의 productId와 일치
...
#define     HW_WS2812_MAX_CH        27    // V260428R1: MAY65S는 indicator 1ch + underglow 26ch 총 27채널
...
#endif
#define INDICATOR_ENABLE            // V260428R1: MAY65S 단일 물리 인디케이터 경로 사용
...
#define RGBLIGHT_INDICATOR_SLOT_COUNT 1   // V260428R1: MAY65S VIA 인디케이터는 1개 슬롯만 노출
