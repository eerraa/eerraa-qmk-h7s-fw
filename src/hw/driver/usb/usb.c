...
static const uint16_t usb_boot_mode_expected_interval_table[USB_BOOT_MODE_MAX] = { // V251006R6 BootMode 기대 간격을 중앙 테이블로 통합
  125U,
  250U,
  500U,
  1000U,
...
uint16_t usbBootModeGetExpectedIntervalUs(void)                      // V251006R6 BootMode 기대 간격 조회 함수로 중복 테이블 제거
{
  if (usb_boot_mode < USB_BOOT_MODE_MAX)
  {
