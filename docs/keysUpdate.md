...
| QMK 매트릭스 폴백 | `#else` 블록은 DMA 스냅샷 복사 실패 시 조기 탈출하도록 보강됨 | 폴백을 재활성화할 경우 별도 레거시 스캔 함수가 필요함은 동일합니다.【F:src/ap/modules/qmk/port/matrix.c†L74-L86】 |
...
- QMK 폴백 블록은 DMA 스냅샷 복사에 실패할 경우 즉시 탈출하도록 보강해 비활성 경로의 안전성을 높였습니다.【F:src/ap/modules/qmk/port/matrix.c†L75-L86】
