...
| User-facing copy | `docs/readme.txt`, `docs/usevia.txt`, `docs/via_keycodes.txt`; `via_keycodes.txt` is this repository's canonical distribution copy of the board-neutral guide and stays content-identical to the EERRAA QMK repository copy | `version` (`docs/readme.txt`) |
